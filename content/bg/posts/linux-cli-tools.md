...
date:        2023-11-30
description: "Колекция от любими инструменти за Линукс командния ред — от терминални мултиплексори до файлови мениджъри."
tags:        ["linux", "инструменти", "терминал", "колекция"]
