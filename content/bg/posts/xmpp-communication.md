...
date:        2019-04-05
url:         "/posts/XMPP-communication"
weight:      2
description: "XMPP (известен също като Jabber) е добре установен протокол за незабавни съобщения, който милиони използват всеки ден."
tags:        ["xmpp", "комуникация", "ръководство"]
...
![Централизирана комуникация](centralized-communication-dark.JPG)
![Централизирана комуникация](centralized-communication-light.JPG)
...
![Децентрализирана комуникация](decentralized-communication-dark.JPG)
![Децентрализирана комуникация](decentralized-communication-light.JPG)
...
Ако търсите български сървър, [Chatrix.One](https://chatrix.one/bg/) може да се окаже вашето кътче.
